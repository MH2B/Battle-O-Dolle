...
public struct PlayersInGameSettings
{
    ...
    public void SetTheSetting(string _playerName , string _heroName , string _matchID)
	{
...
public class MirrorPlayer : NetworkBehaviour
{
    ...
    void CmdHostARoom(bool _isPublic , int roomMaxPlayerSize)
    {
        ...
        TRpcSuccesfullyHosted(isSuccessed);
    }

    [TargetRpc]
    void TRpcSuccesfullyHosted(bool success)
    {
    ...
    void CmdJoinARoom(string _roomName , GameObject _player)
    {
        ...
        TRpcSuccesfullyJoined(isSuccessed);
    }

    [TargetRpc]
    void TRpcSuccesfullyJoined(bool success)
    {
    ...
    void TRpcBeginGame()
    {
        ...
        PlayersInGameSettings thisPlayerInGameSettings = new PlayersInGameSettings {};
        print("11111 : " + matchID);
        thisPlayerInGameSettings.SetTheSetting(playerName, currentHero , matchID);
